...
return [
    ...
    "prohibits" => "Поле :attribute не должно присутствовать при наличии :other.",
    "regex" => "Значение поля :attribute имеет некорректный формат.",
    "required" => "Поле :attribute обязательно для заполнения.",
    "required_array_keys" => "Поле :attribute должно содержать элементы для следующих значений: :values.",
    ...
    "size.file" => "Размер файла, указанный в поле :attribute, должен составлять :size Кб.",
    "size.numeric" => "Значение поля :attribute должно быть равно :size.",
